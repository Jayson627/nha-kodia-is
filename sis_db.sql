...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2024 at 03:21 AM
...
CREATE TABLE `student_list` (
  ...
  `date_created` datetime NOT NULL DEFAULT current_timestamp(),
  `date_updated` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  `voter_registration` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `student_list` (`id`, `roll`, `firstname`, `middlename`, `lastname`, `gender`, `contact`, `present_address`, `permanent_address`, `dob`, `status`, `delete_flag`, `date_created`, `date_updated`, `voter_registration`) VALUES
(1, '231415061007', 'Mark', 'D', 'Cooper', 'Male', '09123456789', 'This my sample present address.', 'This my sample permanent address.', '2007-06-23', 1, 0, '2022-01-27 11:14:07', '2024-06-29 02:48:26', 'on'),
(9, 'programer', 'jayson', 'Apawan', 'Medallo', 'Male', '22222222222', 'ddddddddd', 'ddddddddd', '2024-05-29', 1, 0, '2024-06-29 02:51:46', NULL, 'on');
...
(1, 'name', ''),
(6, 'short_name', 'Kodia'),
(11, 'logo', 'uploads/logo1.jpg'),
(13, 'user_avatar', 'uploads/user_avatar.jpg'),
(14, 'cover', 'uploads/kodia.jpg');
